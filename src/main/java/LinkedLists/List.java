...
public class List<E> {
    ...
    public boolean isEqual(List<E> list){
        ListNode<E> i = firstNode;
        ListNode<E> j = list.firstNode;

        while(i != null && j != null && i.data.equals(j.data)) {
            i = i.nextNode;
            j = j.nextNode;
        }
